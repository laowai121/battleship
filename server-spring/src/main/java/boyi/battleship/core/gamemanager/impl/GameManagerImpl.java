package boyi.battleship.core.gamemanager.impl;
...
public class GameManagerImpl implements GameManager {
    ...
    @Autowired
    public GameManagerImpl(@NotNull PlayerStore playerStore,
    ...
    public synchronized List<PlayerSpecificChatMessage> getChatHistoryFor(@NotNull Player player) {
        return playerSpecificChatMessageGenerator.generate(
                chatStore.getOrCreateFor(player.getGame(), new Chat()).getMessages(),
                player
        );
    }
