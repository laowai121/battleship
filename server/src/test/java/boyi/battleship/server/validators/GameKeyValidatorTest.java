...
public class GameKeyValidatorTest {
    private static final String ERROR_INVALID_KEY = "Invalid Game Key. Game Key should be a sequence of lower case alphanumerics of length " + KeyGenerator.KEY_LENGTH;
