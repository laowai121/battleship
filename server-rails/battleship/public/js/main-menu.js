...
var MainMenu = {
    template: '<div class="battleship-container">' +
              ...
              '    </div>' +
              '    <div class="main-menu-container" v-show="formDisplayed == MenuForm.MAIN">' +
              '        <h2>Battleship Game</h2>' +
              '        <div class="row" style="margin-top: 21px;">' +
              '            <div class="col-md-12">' +
              '                <button @click="openCreateGameMenu()" :disabled="loading"' +
              '                        type="button" class="btn btn-primary btn-block">Create New Game</button>' +
              '            </div>' +
              '        </div>' +
              '        <div class="row" style="margin-top: 5px;">' +
              '            <div class="col-md-12">' +
              '                <button @click="openJoinGameMenu" :disabled="loading"' +
              '                        type="button" class="btn btn-warning btn-block">Join Existing Game</button>' +
              '            </div>' +
              '        </div>' +
              '    </div>' +
              '    <div class="create-game-menu-container" v-show="formDisplayed == MenuForm.CREATE_GAME">' +
              ...
              '                           :disabled="loading"' +
              '                           :class="{ \'validation-error\': createGameForm.playerName.invalid }"' +
              '                           @keydown="createGameTextInputKeyDown"' +
              ...
              // '                        <option v-for="n in 17" :value="n - 1">{{ n - 1 }}</option>' +
              // '                    </select>' +
              // '                </div>' +
              // '            </div>' +
              // '        </div>' +
              ...
              // '            <div class="col-md-12">' +
              // '                <button :disabled="loading"' +
              // '                        @click="createGameAsSpectatorButtonClicked"' +
              ...
              '        </div>' +
              '    </div>' +
              '    <div class="join-game-menu-container" v-show="formDisplayed == MenuForm.JOIN_GAME">' +
              ...
              '                           :disabled="loading"' +
              '                           :class="{ \'validation-error\': joinGameForm.playerName.invalid }"' +
              '                           @keydown="joinGameTextInputKeyDown"' +
              ...
              '                           :disabled="loading"' +
              '                           :class="{ \'validation-error\': joinGameForm.gameKey.invalid }"' +
              '                           @keydown="joinGameTextInputKeyDown"' +
              ...
              // '            <div class="col-md-12">' +
              // '                <button :disabled="loading"' +
              // '                        @click="joinGameAsSpectatorButtonClicked"' +
    ...
    methods: {
        openCreateGameMenu: function () {
            this.formDisplayed = MenuForm.CREATE_GAME;
        },
        openJoinGameMenu: function () {
            this.formDisplayed = MenuForm.JOIN_GAME;
        },
        backToMainMenu: function () {
            this.formDisplayed = MenuForm.MAIN;
            this.resetAllForms();
        },
