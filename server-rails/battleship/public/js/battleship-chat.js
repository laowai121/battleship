var BattleshipChat = {
    template: '<div class="chat-container">' +
              ...
              '        <input @keydown="inputChatMessageKeydown" v-model="chatMessage" type="text" class="chat-input form-control" />' +
              '        <button @click="sendMessage" type="button" class="btn btn-sm btn-danger send-chat-message-btn">' +
